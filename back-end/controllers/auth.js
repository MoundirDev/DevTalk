                ...
                <div style="max-width: 520px; margin: auto; background-color: #ffffff; border-radius: 14px; box-shadow: 0 6px 14px rgba(0,0,0,0.1); overflow: hidden;">
                    ...
                    <div style="padding: 25px; color: #333;">
                        ...
                        <p style="font-size: 15px; line-height: 1.6;">
                            Thanks for signing up for <strong>DevTalk</strong>! 🎉  
                            To complete your registration, please verify your email by entering the code below in the app:
                        </p>

                        <h3 style="color: #1e88e5; font-size: 22px; margin: 20px 0;">${verificationCode}</h3>

                        <p style="font-size: 15px; line-height: 1.6;">
                            This verification step helps us keep DevTalk secure for everyone.<br>
